...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 13, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1.2, marginBottom: 10 },
  missionsWrap: { borderRadius: 18, borderWidth: 1, marginBottom: 20, overflow: 'hidden' },
  missionRow: { flexDirection: 'row', alignItems: 'center', gap: 14, padding: 16 },
  missionIconWrap: { width: 56, height: 56, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  missionIcon: { fontSize: 32 },
  missionLabel: { fontSize: 16, fontWeight: '700', marginBottom: 6 },
  missionTrack: { height: 5, borderRadius: 3, overflow: 'hidden', marginBottom: 5 },
  missionFill: { height: 5, borderRadius: 3 },
  missionProgress: { fontSize: 13, fontWeight: '500' },
  missionXP: { borderRadius: 10, borderWidth: 1, paddingHorizontal: 10, paddingVertical: 6 },
  missionXPText: { fontSize: 14, fontWeight: '800' },
  featureGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginBottom: 20 },
  featureCard: { width: '47.5%', borderRadius: 18, borderWidth: 1, padding: 16, minHeight: 155, position: 'relative', overflow: 'hidden' },
  featureIconWrap: { width: 72, height: 72, borderRadius: 18, alignItems: 'center', justifyContent: 'center', marginBottom: 10 },
  featureIcon: { fontSize: 44 },
  featureTitle: { fontSize: 16, fontWeight: '800', marginBottom: 3 },
