...
const styles = StyleSheet.create({
  ...
  missionIconWrap: { width: 52, height: 52, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  missionIcon: { fontSize: 28 },
  missionLabel: { fontSize: 15, fontWeight: '700', marginBottom: 6 },
  missionTrack: { height: 5, borderRadius: 3, overflow: 'hidden', marginBottom: 5 },
  missionFill: { height: 5, borderRadius: 3 },
  missionProgress: { fontSize: 12, fontWeight: '500' },
  missionXP: { borderRadius: 10, borderWidth: 1, paddingHorizontal: 10, paddingVertical: 6 },
  missionXPText: { fontSize: 13, fontWeight: '800' },
  featureGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginBottom: 20 },
  featureCard: { width: '47.5%', borderRadius: 18, borderWidth: 1, padding: 16, minHeight: 145, position: 'relative', overflow: 'hidden' },
  featureIconWrap: { width: 68, height: 68, borderRadius: 18, alignItems: 'center', justifyContent: 'center', marginBottom: 10 },
