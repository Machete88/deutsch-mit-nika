...
const styles = StyleSheet.create({
  ...
  statCard: { flex: 1, borderRadius: 16, borderWidth: 1, paddingVertical: 16, alignItems: 'center', gap: 6, shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.25, shadowRadius: 10, elevation: 4 },
  statValue: { fontSize: 22, fontWeight: '900' },
  statLabel: { fontSize: 13, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.5 },
  sectionTitle: { fontSize: 13, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1.2, marginBottom: 12 },
  actionGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 12, marginBottom: 20 },
  actionCard: { width: '47.5%', borderRadius: 20, borderWidth: 1, padding: 16, minHeight: 150, position: 'relative', overflow: 'hidden', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.3, shadowRadius: 12, elevation: 6 },
  actionIconWrap: { width: 72, height: 72, borderRadius: 18, alignItems: 'center', justifyContent: 'center', marginBottom: 10 },
  ...
  statsDetailIcon: { fontSize: 36 },
  statsDetailValue: { fontSize: 24, fontWeight: '900' },
  statsDetailLabel: { fontSize: 13, textAlign: 'center', fontWeight: '600' },
