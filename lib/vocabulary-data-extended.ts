...
export const examQuestions: ExamQuestion[] = [
  ...
  // B1 Listening Questions (Hörverstehen)
  {
    id: 'exam-b1-listen-001',
    type: 'listening',
    cefrLevel: 'B1',
    category: 'Hörverstehen',
    audioText: 'Guten Morgen! Ich möchte einen Termin beim Arzt machen. Ich habe seit drei Tagen Kopfschmerzen und fühle mich sehr müde. Haben Sie nächste Woche einen freien Termin?',
    russian: 'У мужчины болит голова уже 3 дня. Что он хочет сделать?',
    german: 'Was möchte der Mann machen?',
    options: ['Einen Arzttermin vereinbaren', 'Ein Medikament kaufen', 'Ins Krankenhaus fahren', 'Den Arzt anrufen'],
    correctAnswer: 'Einen Arzttermin vereinbaren',
    explanation: 'Er sagt: "Ich möchte einen Termin beim Arzt machen" (я хочу записатьсь к врачу)',
  },
  {
    id: 'exam-b1-listen-002',
    type: 'listening',
    cefrLevel: 'B1',
    category: 'Hörverstehen',
    audioText: 'Entschuldigung, können Sie mir helfen? Ich suche den Hauptbahnhof. Ich bin neu in der Stadt und kenne mich hier nicht aus. Wie weit ist es von hier?',
    russian: 'Женщина спрашивает о чём?',
    german: 'Wonach fragt die Frau?',
    options: ['Nach dem Weg zum Hauptbahnhof', 'Nach einem Hotel', 'Nach einem Restaurant', 'Nach der Bushaltestelle'],
    correctAnswer: 'Nach dem Weg zum Hauptbahnhof',
    explanation: 'Sie sagt: "Ich suche den Hauptbahnhof" (я ищу главный вокзал)',
  },
  {
    id: 'exam-b1-listen-003',
    type: 'listening',
    cefrLevel: 'B1',
    category: 'Hörverstehen',
    audioText: 'Hallo Anna! Ich rufe an, weil ich heute leider nicht zur Party kommen kann. Mein Auto ist kaputt und der Bus fährt nicht mehr so spät. Kannst du mich vielleicht abholen?',
    russian: 'Почему человек не может прийти на вечеринку?',
    german: 'Warum kann er nicht zur Party kommen?',
    options: ['Sein Auto ist kaputt und der Bus fährt nicht', 'Er ist krank', 'Er muss arbeiten', 'Er hat keine Zeit'],
    correctAnswer: 'Sein Auto ist kaputt und der Bus fährt nicht',
    explanation: 'Er sagt: "Mein Auto ist kaputt und der Bus fährt nicht mehr so spät"',
  },
